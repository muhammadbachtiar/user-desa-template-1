                    ...
                    <div className="col-span-6 grid grid-cols-6 gap-1 px-6 md:px-0 justify-between">
                        ...
                        <div className="col-span-6 md:col-span-4 lg:col-span-5 text-end">
                            <div className="relative w-full">
                                <input type="search" id="search-dropdown"value={search} onChange={handleChange} className="block px-5 pe-12 w-full rounded-sm text-sm text-gray-900 bg-gray-50 border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Cari judul ..." />
                        ...
                        {isLoading || (!articles || !articles.pages[0] || articles.pages[0]?.data.length === 0) && isFetching ? (
                            ...
                            <>
                                {allArticles.map((card) => 
                                    <Link to={`/article/${card.slug}`} tabIndex={1} key={card.slug} className="col-span-6 md:col-span-3 px-3 md:px-0 lg:col-span-2 w-full">
