                        ...
                        <>
                            ...
                            <div className="pt-12 min-h-screen">
                                ...
                                <div className='flex flex-wrap items-center justify-center w-full my-2 gap-x-2 gap-y-1 min-w-0'>
                                    <span className="self-center align-baseline text-sm font-semibold uppercase text-[#DDA853] shrink-0" title={article?.category?.name}>
                                        {truncateWords(article?.category?.name || "Berita", 2)}
                                    </span>
                                    <div className="self-center w-px h-3.5 mx-1 bg-gray-400 shrink-0"></div>
                                    <span className="self-center align-baseline text-xs font-medium text-black shrink-0">{article?.user?.name}</span>
                                    <div className="self-center w-px h-3.5 mx-1 bg-gray-400 shrink-0"></div>
                                    <span className="self-center align-baseline text-xs font-medium text-black shrink-0">{article?.published_at}</span>
                                </div>
