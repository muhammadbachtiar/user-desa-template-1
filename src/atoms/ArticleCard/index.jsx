...
const ArticleCard = ({ thumbnail, title, description, category, published_at }) => {
         ...
         <div className="px-0 sm:px-3 group hover:scale-100 focus:scale-100 transition duration-300 ease-in-out">
            ...
            <div className="p-1 pe-6">
                <div className='flex flex-row col-span-8 my-2 gap-1 justify-items-start items-start'>
                    <span className="self-center align-baseline text-base font-semibold uppercase text-[#DDA853]">{category}</span>
                ...
                <h5 className="my-2 leading-5 text-lg line-clamp-3 font-bold tracking-tight text-gray-900  dark:text-white">{title}</h5>
