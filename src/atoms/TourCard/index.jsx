  ...
  return (
    <>
      <div className="col-span-6 w-full rounded-lg dark:bg-gray-800">
        <Link to={`/tour/${slug}`}>
          <h5 className="text-4xl font-bold mb-5 tracking-tighter text-gray-900 dark:text-white hover:text-blue-600">
            {title}
          </h5>
        </Link>
      ...
      <div className="col-span-6 flex flex-col gap-y-1 justify-center items-center dark:bg-gray-800">
        <figure className="w-full aspect-video overflow-hidden rounded-lg shadow-2xl backdrop-blur-2xl">
          <img
